...
int main() {
	...
	Renderer::Plane light = Renderer::Plane(Vector(2, 0, 0), Vector(-1, 0, 0), Vector(0, 1, 0), 2, 2, Renderer::YELLOW, true);
	Renderer::Cube mirror = Renderer::Cube(Vector(1.5, 0, 2.25), 2, Renderer::RED, false);
